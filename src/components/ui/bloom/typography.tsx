...
function BlockQuoteComponent({
  ...
  return (
    <Comp
      className={cn('mt-4 border-l-2 pl-4 text-sm italic sm:mt-6 sm:pl-6 sm:text-base', className)}
      {...props}
    >
      {children}
    </Comp>
...
function LeadComponent({
  ...
  return (
    <Comp
      className={cn('text-muted-foreground text-lg sm:text-xl md:text-2xl', className)}
      {...props}
    >
      {children}
    </Comp>
...
function LargeComponent({
  ...
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp className={cn('text-base font-semibold sm:text-lg md:text-xl', className)} {...props}>
      {children}
    </Comp>
  );
}
...
function SmallComponent({
  ...
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp className={cn('text-xs leading-none font-medium sm:text-sm', className)} {...props}>
      {children}
    </Comp>
  );
}
...
function MutedComponent({
  ...
  const Comp = asChild ? Slot : 'span';
  return (
    <Comp className={cn('text-muted-foreground text-xs sm:text-sm', className)} {...props}>
      {children}
    </Comp>
  );
}
...
function TitleComponent({
  ...
  return (
    <Comp
      className={cn('text-primary text-5xl sm:text-6xl md:text-7xl lg:text-8xl', className)}
      {...props}
    >
      {children}
    </Comp>
...
export { H1, H2, H3, H4, H5, H6, P, BlockQuote, Code, Lead, Large, Small, Muted, Title };
